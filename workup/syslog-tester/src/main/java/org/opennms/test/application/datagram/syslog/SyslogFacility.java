...
package org.opennms.test.application.datagram.syslog;
   ...
   public enum SyslogFacility implements Comparable<SyslogFacility> {
       ...
       // mapping
       private final static Map<String, SyslogFacility> facilityFromLabel = new HashMap<>();
       private final static Map<Integer, SyslogFacility> facilityFromNumericalCode = new HashMap<>();
       ...
       SyslogFacility(int numericalCode,  String label) {
          if (label == null)  throw new IllegalArgumentException("label annot be null");
       ...
       /**
        * Compare on {@link SyslogFacility#numericalCode()}
        */
